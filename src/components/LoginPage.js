...
import { authenticateUser, authenticateGuest } from './auth.js'; // Updated import  
...
const LoginPage = () => {  
  ...
  const handleLogin = async (e) => {  
    ...
    try {  
      ...
      authenticateUser(response.token); // Store user token  
      navigate('/home');  
    } catch (error) {  
  ...
  const handleGuestSignIn = async () => {  
    try {  
      ...
      authenticateGuest(); // Store guest information  
      navigate('/home');  
    } catch (error) {  
